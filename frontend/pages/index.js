      ...
      <div className="container pt-5">
        <div className="row pt-5">
          <div className="col-md-6">
            <br />
            <SectionHello getStyle={getStyle} />
          </div>
          <div className="col-md-6">
            <Image
              src={PatreonHello}
        ...
        <div className="text-center mt-5">
          <h2 style={getStyle.fontCreator}>In the words or our creators</h2>
        </div>
        <CreatorCards style={getStyle} />
      </div>
      <MembershipBenefits />
      <WhoUse getStyle={getStyle} />
      <HowDoes />
      <Footer />
    </>
  );
    ...
    <div className="card">
      ...
      <div className="card-footer" style={props.style.cardSmoke}>
        <div className="card-text p-3">
          <Image src={PatreonRae} alt="Rae" style={{ width: "15%" }} /> &nbsp;
      ...
      <div className="container mt-3 p-5">
        ...
        <div className="row mt-5">
          <div className="col-md-4 p-4 text-center">
            <Image src={PatreonPredictable} alt="" />
          ...
          <div className="col-md-4 p-4 text-center">
            <Image src={PatreonConnection} alt="" />
            <div className="text-center">
              <h4>
                <b>Fan Connection</b>
              </h4>
    ...
    return (
      <div className="row mt-4 mb-4">
        <div className="col-md-6 text-center">
          ...
          />
          {props.image2 ? (
            <Image src={props.image2} alt="second_image" />
          ) : null}
        </div>
        <div className="col-md-6">
